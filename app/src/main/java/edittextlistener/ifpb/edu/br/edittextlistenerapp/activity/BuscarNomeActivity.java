...
import edittextlistener.ifpb.edu.br.edittextlistenerapp.asynctask.BuscarNomeAsyncTast;
...
public class BuscarNomeActivity extends Activity
    ...
    public void onTextChanged(CharSequence charSequence, int start, int before, int count) {
        ...
        if (nome.length() >= TAMANHO_MINIMO_TEXTO) {
            ...
            BuscarNomeAsyncTast buscarNomeAsyncTask = new BuscarNomeAsyncTast(this);

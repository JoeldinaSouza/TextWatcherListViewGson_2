...
public class BuscarNomeAsyncTast extends AsyncTask<Pessoa, Void, Response> {

        private BuscarPessoaCallBack buscarNomeCallBack;

        public BuscarNomeAsyncTast(BuscarPessoaCallBack buscarNomeCallBack) {
        ...
        protected void onPostExecute(Response response) {
            ...
            Log.i("EditTextListener", "HTTP: " + codeHttp
